                ...
                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 12 : 8 }}>
                  <div>
                    ...
                    <div style={{ display: 'flex', gap: 6 }}>
                      ...
                      <select value={tUnidadDosisMaxima} onChange={e => setTUnidadDosisMaxima(e.target.value as 'L/ha' | 'Kg/ha' | 'g/ha' | 'mL/hL' | 'L/hL' | 'g/hL' | 'Kg/hL' | '%(v/v)' | '%(p/p)' | 'g/m²' | 'g/kg semilla' | 'mL/kg semilla' | 'mL/m²' | 'L/m²' | 'mg/m²')} style={{ flexShrink: 0, width: isMobile ? 110 : 'auto', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 6, padding: '8px 6px', color: 'var(--text)', fontSize: 12, fontFamily: 'var(--sans)', outline: 'none' }}>
                        <option value="L/ha">L/ha</option>
                        <option value="Kg/ha">Kg/ha</option>
                        <option value="g/ha">g/ha</option>
                        <option value="mL/hL">mL/hL</option>
