...
export default function Home() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }} onClick={e => { if (menuAbierto && !(e.target as HTMLElement).closest('[data-menu]')) setMenuAbierto(false) }}>

      {/* - HEADER - */}
      <div style={{ background: 'var(--surface)', borderBottom: '1px solid var(--border)', flexShrink: 0, position: 'relative', zIndex: 100 }}>
      ...
      {/* - CONTENIDO - */}
      <div style={{ flex: pestana === 'tratamientos' ? '0 0 0px' : 1, overflow: 'hidden', display: 'flex', minHeight: 0 }}>
          ...
          <div style={{ display: 'flex', width: '100%', height: '100%', position: 'relative' }}>
            ...
            <aside style={{
              ...(isMobile ? {
                ...
                height: panelAbierto ? 'calc(100vh - 120px)' : '60px',
            ...
            {isMobile && (
              <div
                ...
                style={{ padding: '16px 16px 12px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, cursor: 'pointer', flexShrink: 0, minHeight: 60 }}
              >
