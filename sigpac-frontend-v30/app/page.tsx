            ...
            <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <div style={{ display: 'flex', gap: 6 }}>
                  ...
                  {fitoSeleccionado && (
                    <button
                      onClick={() => window.open(`https://servicio.mapa.gob.es/regfiweb/BuscadorProductos/Index?nombre=${encodeURIComponent(fitoSeleccionado.nombre)}`, '_blank')}
                      style={{ padding: '9px 12px', borderRadius: 6, background: 'rgba(77,184,255,0.1)', border: '1px solid rgba(77,184,255,0.3)', color: 'var(--blue)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer', whiteSpace: 'nowrap', fontWeight: 700 }}
                    >
                      🔗 MAPA
                    </button>
                  )}
                  ...
                  <div style={{ marginTop: 6 }}>
                    ...
                    <div style={{ padding: '8px 10px', borderRadius: 6, background: fitoSeleccionado.eliminado ? 'rgba(255,107,107,0.04)' : 'rgba(61,220,110,0.06)', border: `1px solid ${fitoSeleccionado.eliminado ? 'rgba(255,107,107,0.2)' : 'rgba(61,220,110,0.2)'}`, fontSize: 10, fontFamily: 'var(--mono)' }}>
                      ...
                      {fitoSeleccionado.tiene_pdf && fitoSeleccionado.pdf_url && (
                        <button
                          onClick={() => window.open(`${process.env.NEXT_PUBLIC_BACKEND_URL}${fitoSeleccionado.pdf_url}`, '_blank')}
